        ...
        <div className="min-h-screen bg-white flex flex-col md:flex-row relative">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-12 lg:px-24">
                ...
                <div className="max-w-md w-full mx-auto">
                    ...
                    <div className="mb-10">
                        <h2 className="text-3xl lg:text-4xl font-black text-gray-900 tracking-tight">Inicia Sesión</h2>
                        <p className="text-gray-500 font-medium mt-3">Qué bueno verte de nuevo por aquí.</p>
                    </div>
